...
public class TypedProperties {
	 ...
	 * a single key-value pair. This is particularly useful for parsing, for
	 ...
	 *
	 * @param properties
	 *            the existing {@code Properties} object
	 */
	...
	/**
	 * Returns a string representation of the specified array that can be parsed
	 * by {@link TypedProperties}. Returns {@code null} if the array is
	 * {@code null}.
	 *
	 * @param array
	 *            the array
	 * @return a string representation of the specified array that can be parsed
	...
	/**
	 * Returns {@code true} if the specified key is contained in this properties
	 * object; {@code false} otherwise.
	 *
	 * @param key
	 *            the property name
	 * @return {@code true} if the specified key is contained in this properties
	 *         object; {@code false} otherwise
	 */
	...
	/**
	 * Sets the value of the property with the specified name as a {@code byte}.
	 *
	 * @param key
	 *            the property name
	 * @param value
	...
	/**
	 * Sets the value of the property with the specified name as a {@code float}
	 * .
	 *
	 * @param key
	 *            the property name
	...
	/**
	 * Sets the value of the property with the specified name as an {@code int}.
	 *
	 * @param key
	 *            the property name
	 * @param value
	...
	/**
	 * Sets the value of the property with the specified name as a {@code int}
	 * array.
	 *
	 * @param key
	 *            the property name
	...
	/**
	 * Sets the value of the property with the specified name as a {@code long}.
	 *
	 * @param key
	 *            the property name
	 * @param value
	...
	/**
	 * Sets the value of the property with the specified name as a {@code short}
	 * .
	 *
	 * @param key
	 *            the property name
